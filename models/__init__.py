...
class LazyModel:
    def __init__(self, model_class:ModelBase, weight_path):
        self._instance = None
    ...
    def get_instance(self):
        if self._instance is None:
            ...
            self._instance = self.model_class(self.weight_path)
...
Qwen3_14B = LazyModel(Qwen3, os.path.join(_current_dir, 'weights', 'Qwen3-14B'))